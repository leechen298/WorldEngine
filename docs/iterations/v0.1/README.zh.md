...
| `0.1.9-remaining-current-code-coverage` | mixed | review complete | 已补齐 v0.1 当前代码剩余覆盖：Auto-Tune E2E、timeline-navigation E2E 和 live `dashboard-invalid-param` Agent smoke。 |
