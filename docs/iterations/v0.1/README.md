...
| `0.1.8-current-code-test-execution` | mixed | ready for implementation | Run one live `dashboard-params-flow` Agent smoke and implement `dashboard-archive-summary` E2E after document approval. |
