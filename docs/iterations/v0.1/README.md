...
| `0.1.7-current-code-validator-expansion` | mixed | ready for implementation | Add selector and Agent smoke validator infrastructure before live test execution. |
