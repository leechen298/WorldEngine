...
2. 在授权前确认 `CURRENT_STATE.md` 中的当前 route 是 `implementation-authorization-review`，在 `review.md` 记录 `implementation_authorized: yes` 后再切换到 `action-validation-implementation`；否则在 `review.md` 记录 route mismatch。
