...
- `docs/iterations/v0.4/0.4.3-action-intent-validation-and-result-adapter/intent.md`
- `docs/iterations/v0.4/0.4.3-action-intent-validation-and-result-adapter/intent.zh.md`
- `docs/iterations/v0.4/0.4.3-action-intent-validation-and-result-adapter/contract.md`
- `docs/iterations/v0.4/0.4.3-action-intent-validation-and-result-adapter/contract.zh.md`
- `docs/iterations/v0.4/0.4.3-action-intent-validation-and-result-adapter/technical-design.md`
- `docs/iterations/v0.4/0.4.3-action-intent-validation-and-result-adapter/technical-design.zh.md`
