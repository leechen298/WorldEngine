...
runtime migration、village-specific behavior、loader design 或 agent memory，而不是先稳定
最小 world structure。
...
- 不实现 village runtime 或 game-specific logic。
...
village-like surface 只是未来 projection，避免把 WorldEngine 收窄成 village-specific backend。
