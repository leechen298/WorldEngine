...
This release-candidate bundle is approved for final-closeout review handoff. It does not
mark v0.8 final and does not claim product readiness, external validation
PASS, external consumer PASS, frontend/E2E PASS, Agent smoke PASS, autonomous
PASS, generation-quality PASS, or final v0.8 readiness.
...
`0.8.8-v0.8-final-closeout` may start its document-package creation and review
gate. Final closeout still requires its own package, verification, and
evaluator approval.
